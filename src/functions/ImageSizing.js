...
{
	for ( let k = 0; k < document.getElementById("Diag"+diagNumber).getElementsByTagName("AREA").length; k++)
	{
		var eltArea;
		eltArea=document.getElementById("Diag"+diagNumber).getElementsByTagName("AREA");
...
export {SetMap, GetOriginalMap, SizeToHeight, SizeToWidth, OriginalSize, ZoomOut, ZoomIn, ZoomInMultipleView, ZoomOutMultipleView, OriginalSizeMultipleView, SizeToHeightMultipleView, SizeToWidthMultipleView};